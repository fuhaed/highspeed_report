...
def get_tax_declaration_data(filters):
    ...
    non_taxable_purchase_returns_data = get_non_taxable_purchase_returns_summary(filters)
    ...
    non_taxable_sales_returns_total = format_num(non_taxable_sales_returns_data['base_total'])
    
    taxable_purchase_returns_total = format_num(taxable_purchase_returns_data['base_total'])
    taxable_purchase_returns_tax = format_num(taxable_purchase_returns_data['tax_amount'])
    non_taxable_purchase_returns_total = format_num(non_taxable_purchase_returns_data['base_total'])
    
    # إجمالي مرتجعات المبيعات (الخاضعة + غير الخاضعة)
    total_sales_returns = format_num(taxable_sales_returns_total + non_taxable_sales_returns_total)
    
    # إجمالي مرتجعات المشتريات (الخاضعة + غير الخاضعة)
    total_purchase_returns = format_num(taxable_purchase_returns_total + non_taxable_purchase_returns_total)
    
    # إجمالي المبيعات (الخاضعة + غير الخاضعة)
    total_sales = format_num(taxable_sales_original_total + non_taxable_sales_original_total)
    
    # حساب الصافي بعد خصم المرتجعات
    taxable_sales_net_total = format_num(taxable_sales_original_total - taxable_sales_returns_total)
    taxable_sales_net_tax = format_num(taxable_sales_original_tax - taxable_sales_returns_tax)
    non_taxable_sales_net_total = format_num(non_taxable_sales_original_total - non_taxable_sales_returns_total)
    ...
    non_taxable_purchase_original_total = format_num(non_taxable_purchase_data['base_total'])
    
    # إجمالي المشتريات (الخاضعة + غير الخاضعة)
    total_purchases = format_num(taxable_purchase_original_total + non_taxable_purchase_original_total)
    
    # حساب إجمالي المشتريات وضرائبها (بعد خصم المرتجعات)
    taxable_purchase_net_total = format_num(taxable_purchase_original_total - taxable_purchase_returns_total)
    taxable_purchase_adjustments = format_num(taxable_purchase_data['adjustments'] - taxable_purchase_returns_data['adjustments'])
    taxable_purchase_net = format_num(taxable_purchase_data['net_amount'] - taxable_purchase_returns_data['net_amount'])
    taxable_purchase_tax = format_num(taxable_purchase_original_tax - taxable_purchase_returns_tax)
    
    non_taxable_purchase_net_total = format_num(non_taxable_purchase_original_total - non_taxable_purchase_returns_total)
    
    # إجمالي صافي المشتريات بعد خصم المرتجعات (الخاضعة + غير الخاضعة)
    total_purchase_net = format_num(taxable_purchase_net_total + non_taxable_purchase_net_total)
    ...
    total_recoverable_tax = format_num(taxable_purchase_tax + journal_entries_tax + payment_entries_tax)
    ...
    tax_data = [
        ...
        {
            "description": _("Standard Rate Taxable Sales"),
        ...
        {
            "description": _("Non-Taxable or Zero-Rated Sales"),
        ...
        {
            "description": _("Total Sales"),
            "amount": total_sales,
            "adjustments": format_num(taxable_sales_data['adjustments'] + non_taxable_sales_data['adjustments']),
            "net_amount": format_num(taxable_sales_data['net_amount'] + non_taxable_sales_data['net_amount']),
            "tax_amount": format_num(taxable_sales_data['tax_amount'])
        },
        {
            "description": _("Standard Rate Taxable Sales Returns"),
        ...
        {
            "description": _("Non-Taxable Sales Returns"),
        ...
        {
            "description": _("Total Sales Returns"),
            "amount": total_sales_returns,
            "adjustments": format_num(taxable_sales_returns_data['adjustments'] + non_taxable_sales_returns_data['adjustments']),
            "net_amount": format_num(taxable_sales_returns_data['net_amount'] + non_taxable_sales_returns_data['net_amount']),
            "tax_amount": format_num(taxable_sales_returns_data['tax_amount'])
        },
        {
            "description": _("Net Sales (After Returns)"),
            "amount": total_sales_net,
            "adjustments": format_num((taxable_sales_data['adjustments'] + non_taxable_sales_data['adjustments']) - 
                                     (taxable_sales_returns_data['adjustments'] + non_taxable_sales_returns_data['adjustments'])),
            "net_amount": format_num((taxable_sales_data['net_amount'] + non_taxable_sales_data['net_amount']) - 
                                    (taxable_sales_returns_data['net_amount'] + non_taxable_sales_returns_data['net_amount'])),
        ...
        {
            "description": _("Standard Rate Taxable Purchases"),
        ...
        {
            "description": _("Non-Taxable or Zero-Rated Purchases"),
        ...
        },
        {
            ...
            "adjustments": format_num(taxable_purchase_data['adjustments'] + non_taxable_purchase_data['adjustments']),
            "net_amount": format_num(taxable_purchase_data['net_amount'] + non_taxable_purchase_data['net_amount']),
            "tax_amount": format_num(taxable_purchase_data['tax_amount'])
        },
        {
            "description": _("Standard Rate Taxable Purchase Returns"),
        ...
        {
            "description": _("Non-Taxable Purchase Returns"),
        ...
        {
            "description": _("Total Purchase Returns"),
            "amount": total_purchase_returns,
            "adjustments": format_num(taxable_purchase_returns_data['adjustments'] + non_taxable_purchase_returns_data['adjustments']),
            "net_amount": format_num(taxable_purchase_returns_data['net_amount'] + non_taxable_purchase_returns_data['net_amount']),
            "tax_amount": format_num(taxable_purchase_returns_data['tax_amount'])
        },
        {
            "description": _("Net Purchases (After Returns)"),
            "amount": total_purchase_net,
            "adjustments": format_num((taxable_purchase_data['adjustments'] + non_taxable_purchase_data['adjustments']) - 
                                     (taxable_purchase_returns_data['adjustments'] + non_taxable_purchase_returns_data['adjustments'])),
            "net_amount": format_num((taxable_purchase_data['net_amount'] + non_taxable_purchase_data['net_amount']) - 
                                    (taxable_purchase_returns_data['net_amount'] + non_taxable_purchase_returns_data['net_amount'])),
        ...
        {
            "description": _("Expenses (Journal Entries)"),
        ...
        {
            "description": _("Expenses (Payment Entries)"),
        ...
        {
            "description": _("Total Recoverable Tax (Purchases and Expenses)"),
            "amount": format_num(taxable_purchase_net_total + journal_entries_amount + payment_entries_amount),
            "adjustments": taxable_purchase_adjustments,
            "net_amount": format_num(taxable_purchase_net + journal_entries_amount + payment_entries_amount),
        ...
        {
            "description": _("Total VAT Due for Current Tax Period"),
            "amount": "",
            "adjustments": "",
            "net_amount": "",
...
def get_taxable_sales_summary(filters):
    ...
    if filters.get("cost_center"):
        conditions.append("EXISTS (SELECT name FROM `tabSales Invoice Item` WHERE parent = `tabSales Invoice`.name AND cost_center = %(cost_center)s)")
    ...
    return sales_summary[0] if sales_summary else {
        "base_total": 0, 
        "net_amount": 0, 
        "adjustments": 0, 
        "tax_amount": 0
...
def get_non_taxable_sales_summary(filters):
    ...
    conditions.append("(total_taxes_and_charges = 0 OR total_taxes_and_charges IS NULL)")
    ...
    return non_taxable_sales_summary[0] if non_taxable_sales_summary else {
        "base_total": 0, 
        "net_amount": 0, 
        "adjustments": 0, 
        "tax_amount": 0
...
def get_non_taxable_returns_summary(filters):
    ...
    return non_taxable_returns_summary[0] if non_taxable_returns_summary else {
        "base_total": 0, 
        "net_amount": 0, 
        "adjustments": 0, 
        "tax_amount": 0
...
def get_taxable_purchase_summary(filters):
    ...
    if filters.get("cost_center"):
        conditions.append("EXISTS (SELECT name FROM `tabPurchase Invoice Item` WHERE parent = `tabPurchase Invoice`.name AND cost_center = %(cost_center)s)")
        values["cost_center"] = filters.get("cost_center")
...
def get_non_taxable_purchase_summary(filters):
    ...
    return non_taxable_purchase_summary[0] if non_taxable_purchase_summary else {
        "base_total": 0, 
        "net_amount": 0, 
        "adjustments": 0, 
        "tax_amount": 0
...
def get_non_taxable_purchase_returns_summary(filters):
    ...
    return non_taxable_purchase_returns_summary[0] if non_taxable_purchase_returns_summary else {
        "base_total": 0, 
        "net_amount": 0, 
        "adjustments": 0, 
        "tax_amount": 0
...
def get_returns_summary(filters):
    ...
    return returns_summary[0] if returns_summary else {
        "base_total": 0, 
        "net_amount": 0, 
        "adjustments": 0, 
        "tax_amount": 0
...
def get_purchase_returns_summary(filters):
    ...
    return purchase_returns_summary[0] if purchase_returns_summary else {
        "base_total": 0, 
        "net_amount": 0, 
        "adjustments": 0, 
        "tax_amount": 0
...
def get_journal_entries_tax_summary(filters):
    ...
    # شرط إضافي للتأكد من أن نوع القيد هو _("Journal Entry")
    ...
    return debit_tax_summary[0] if debit_tax_summary else {
        "base_total": 0,
        "tax_amount": 0
    }
...
def get_payment_entries_tax_summary(filters):
    ...
    return payment_entries_summary[0] if payment_entries_summary else {
        "base_total": 0,
        "tax_amount": 0
    }
...
def get_summary(data):
    ...
    def find_row(description):
        return next((row for row in data if row.get("description") == description), {"amount": 0, "tax_amount": 0})
    
    # الحصول على بيانات الصفوف المهمة
    taxable_sales = find_row(_("Standard Rate Taxable Sales"))
    non_taxable_sales = find_row(_("Non-Taxable or Zero-Rated Sales"))
    total_sales = find_row(_("Total Sales"))
    taxable_sales_returns = find_row(_("Standard Rate Taxable Sales Returns"))
    non_taxable_sales_returns = find_row(_("Non-Taxable Sales Returns"))
    total_sales_returns = find_row(_("Total Sales Returns"))
    sales_net = find_row(_("Net Sales (After Returns)"))
    
    taxable_purchases = find_row(_("Standard Rate Taxable Purchases"))
    non_taxable_purchases = find_row(_("Non-Taxable or Zero-Rated Purchases"))
    total_purchases = find_row(_("Total Purchases"))
    taxable_purchase_returns = find_row(_("Standard Rate Taxable Purchase Returns"))
    non_taxable_purchase_returns = find_row(_("Non-Taxable Purchase Returns"))
    total_purchase_returns = find_row(_("Total Purchase Returns"))
    purchase_net = find_row(_("Net Purchases (After Returns)"))
    
    journal_entries = find_row(_("Expenses (Journal Entries)"))
    payment_entries = find_row(_("Expenses (Payment Entries)"))
    total_recoverable = find_row(_("Total Recoverable Tax (Purchases and Expenses)"))
    
    vat_due = find_row(_("Total VAT Due for Current Tax Period"))
    ...
    return [
        ...
        {
            "label": _("Total Purchase Returns"),
        ...
        },
        {
            ...
            "indicator": "Red" if float(vat_due.get('tax_amount') or 0) < 0 else "Green"
        }
    ]